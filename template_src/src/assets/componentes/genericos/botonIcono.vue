...
<div class="w-100">
    ...
    <template v-else>
    <button class="button boton-verdesecap" @click="$emit('click')">
        <div class="row justify-content-center " :class="{'letra-blanco-3-8vw py-5px':small, 'letra-blanco-4-8vw py-13px': (!small)}">
            <span>{{texto}}</span>
        </div>
    </button>
    </template>
