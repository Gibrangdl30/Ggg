                ...
                <div class="col-12 text-justify mt-2" >
                    <div class="row w-100 m-0 p-0 letra-gray3-25 white-space-preline text-justify py-3 justify-content-center">AVISO DE PRIVACIDAD</div>
                     <div class="row w-100 m-0 letra-gray3-16 white-space-preline ">
                         En cumplimiento con lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de Particulares y con la finalidad de asegurar la protección y privacidad de los datos personales, así como regular el acceso, rectificación, oposición y cancelación de estos PAPARATZ,  establece lo siguiente:
Este aviso es relacionado al uso de la App para dispositivos móviles con sistema operativo IOS y la APP para dispositivos móviles con sistema operativo Android.

DATOS PERSONALES.

La información solicitada y recabada o recibida por PAPARATZ ya sea en forma física, electrónica o cualquier otro medio, consistirá únicamente en el correo electrónico.
...
Podrás solicitar el ejercicio de sus derechos enviándonos un correo electrónico a la dirección siguiente: legal@paparatzapp.com
...
Este aviso fue actualizado por ultima vez el día 15 de MARZO de 2022 mas puede cambiar en cualquier momento y sin previo aviso mas que el publicado en nuestra pagina web https://paparatzapp.com
