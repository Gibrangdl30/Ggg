    ...
    export default{
        ...
        methods:{
            ...
            goToDetelle(id){
                ...
                if(this.$store.getters.postStateObject('msn')){
                    this.$store.dispatch('postSaveMsn',[this.$store.getters.postStateObject('msn')]);
                }
                this.$store.commit('setPostState',['msn',null]);
                this.router.navigate('/mensajes_chat');
            },
