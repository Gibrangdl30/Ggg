<template>
    <f7-page>
    <div class="vista">
        <nav-bar tipo="inicio" :backs="true" :title="'Terms and conditions'" :fix="1"></nav-bar>
            ...
            <div class="row w-100 m-0 back-color-blanco">
                <div class="row w-100 m-0 py-2 justify-content-center">
                    <div class="col-12 text-justify mt-2" >
                        <div class="row w-100 m-0 p-0 letra-gray3-22 white-space-preline text-justify pt-3 justify-content-center">Interpretation and Definitions</div>
                        <div class="row w-100 m-0 letra-gray3-16 white-space-preline ">
                            ...
                            Application means the software program provided by the Company downloaded by You to a Device, named Namee
                            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Namee.
                            ...
                            Acknowledgment;
                            By clicking the "I accept" button, downloading or using the Application, You are agreeing to be bound by the terms and conditions of this Agreement. If You do not agree to the terms of this Agreement, do not click on the "I Agree" button, do not download or do not use the Application.
