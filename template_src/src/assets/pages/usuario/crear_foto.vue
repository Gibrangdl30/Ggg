<template>
    <f7-page class="" id="inicio">
        <div class="vista">
            <nav-bar tipo="inicio" title="Nueva foto" :customBack="true" :fix="1"   />
            ...
            <div class="contenedor-page-tabs back-color-blanco">
                ...
                <div class="row w-100 m-0 pt-2 px-3" v-if="0">
                    <div class="row w-100 m-0 letra-gray4-18">Selecciona el usuario del que eres paparatz</div>
                    ...
                    <div class="row w-100 m-0" v-for="a of share" :key="a.id">
                        <amigosRow :data="a.usuario" :solicitud="a" v-model="formPost" :check="formPost.para_id == a.usuarios_id" @set="formPost.para_id = a.usuarios_id"  />
                    </div>
                </div>
            ...
            <div class="row w-100 m-0 px-2 py-2">
                <div class="row w-100 m-0 px-3 py-2 pb-3" @click="save()">
                    <botonApp texto="Confirmar" tipo="azul" radius="30px" />
                </div>
            </div>
...
const moment = require('moment-timezone');
    ...
    export default{
        ...
        methods:{
            ...
            save(){
                this.formPost.para_id = this.asignado.usuarios_id;
