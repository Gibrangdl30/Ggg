<template>
    <f7-page id="inicio" >
        ...
        <div class="vista" v-vistak>
            ...
            <nav-bar tipo="inicio" :backs="true" :title="'Historial compras'" :right="false" />
                            ...
                            <div class="row w-100 m-0 carta px-2" >
                                <div class="row w-100 m-0 py-2 border-b-gray0-1" >
                                    <div class="w-12vw h-12vw mt-2 ">
                                        <imagen clase="border-radius-10px" src="https://socialflow.app/backend/apiv1/imagenes/w1.jpg" />
                                    </div>
