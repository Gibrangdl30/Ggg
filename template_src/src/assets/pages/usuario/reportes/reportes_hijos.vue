<template>
    <f7-page class="" id="inicio">
        <div class="vista">
            <nav-bar tipo="inicio" title="Reportes" :backs="true" :fix="1"  />

            <div class="contenedor-page-tabs back-color-blanco">
                <div class="row w-100 m-0">

                    <div class="row w-100 m-0">
                        <div class="row w-100 m-0" v-if="(reportes && reportes.length)">
                            <div class="row w-100 m-0" v-for="a of reportes " :key="a.id">
                                <reportsRow 
                                    :ruta="'/detalle_reporte'"
                                    :data="a" 
                                />
                            </div>
                        </div>
...
const moment = require('moment')
    export default{
        ...
        computed: {
            ...
            reportes(){return this.$store.getters.userStateArray('reportes'); },
        },
        mounted(){
