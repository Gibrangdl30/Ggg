<template>
    <f7-page class="" id="inicio">
        ...
        <div class="vista">
            <nav-bar tipo="init" title="Discharged patients" :backs="false" :logo="true" :profile="true" :chat="true" />
            ...
            <div class="w-auto position-absolute bottom-10 right-3 " @click="router.navigate('/registro_paciente')">
