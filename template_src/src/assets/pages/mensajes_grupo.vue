<template>
    <f7-page id="mensaje_chat">
        <div class="vista" v-vistak v-chatss >
            <nav-bar tipo="chatgrupo"  :backs="true" :title="chat.nombre" :usuario="chat.usuario" :contactos="contactos" />
    ...
    export default{
        ...
        methods:{
            ...
            enviarMensaje(){
                ...
                this.$store.dispatch('postSaveMsnGrupo',[this.mensaje, this.grupo.id]);
                this.mensaje = null;
            },
